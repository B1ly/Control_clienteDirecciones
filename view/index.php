...
<div class="container-fluid row">
    <form class="col-4 p-3" method="POST">
        <h3 class="text-center text-secondary">Agregar cliente</h3>
        <?php
         include("../model/open_connection.php");
         include("../controller/add_client.php");
        ?>
    <div class="mb-3">
    ...
    <button type="submit" class="btn btn-primary"name="btnAdd" value="ok" >Agregar</button>
    </form>
